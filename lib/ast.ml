...
module Pp : sig
  ...
  let pp_identifier (buf : Buffer.t) (Identifier { name }) (indent_level : int) : unit =
    add_indent buf indent_level;
    Buffer.add_string buf "Identifier ";
    Buffer.add_string buf name
  ;;

  let pp_unary_op (buf : Buffer.t) (op : unary_operator) (indent_level : int) : unit =
    add_indent buf indent_level;
  ...
  let pp_binary_op (buf : Buffer.t) (op : binary_operator) (indent_level : int) : unit =
    add_indent buf indent_level;
  ...
  let pp_func (buf : Buffer.t) (Function { name; body }) (indent_level : int) : unit =
    add_indent buf indent_level;
